 ...
 * 类描述：
 * Created by mark on 2018/6/5 10:44
 * 修改人：mark
 * 修改时间：2018/6/5 10:44
 * 修改备注：
 */
public class UrlsControl {
    public static final String BASEURL = "http://api.jisuapi.com/";
    //    美图获取接口
    public static final String BASEURL_MEINV = "https://www.apiopen.top/";
    //随机推荐热门段子（包含文字、图片、GIF、视频）
//    public static final String BASEURL = "https://www.apiopen.top/satinApi?type=1&page=1";
...
创建应用接口
https://www.apiopen.top/appIcreateUserKey?appId=com.chat.peakchao&passwd=123456
增加统计信息接口
